...
import { ShieldCheck, Plus, LogOut, User, Sparkles } from "lucide-react";
  ...
  return (
    <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-4 pb-2 border-b border-border/70">
      ...
      <div className="flex flex-wrap items-center gap-2.5 w-full lg:w-auto justify-start lg:justify-end">
        ...
        <div className="px-3 py-2 rounded-xl bg-purple-50 dark:bg-purple-950/60 border border-purple-200/60 dark:border-purple-800/60 text-purple-900 dark:text-purple-300 text-xs font-bold flex items-center gap-1.5">
        ...
        <button
          ...
          className="px-3.5 py-2 rounded-xl text-xs font-bold text-rose-600 hover:text-rose-700 bg-rose-50 hover:bg-rose-100 dark:bg-rose-950/40 dark:hover:bg-rose-950/70 border border-rose-200 dark:border-rose-900/60 transition-all flex items-center gap-1.5 shadow-2xs cursor-pointer active:scale-95"
