...
export function SuperAdminSidebar({ mobileOpen, onClose }: SuperAdminSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`w-64 border-r border-border/80 bg-card shrink-0 flex flex-col h-full overflow-hidden transition-all duration-200 md:flex ${
          mobileOpen
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto min-h-0 px-3.5 space-y-1 overscroll-contain">
          {ADMIN_NAV.map((item) => {
